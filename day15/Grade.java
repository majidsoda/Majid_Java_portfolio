...
public class Grade {
	...
	/*
	 * if grade is 'A' or 'a' then print "90 - 100" if grade is 'B' or 'b' then
	 * print "65 - 89" if grade is 'C' or 'c' then print "50 - 64" if grade is 'F'
	 * or 'f' then print "less than 50" otherwise print "not valid grade"
	 */
