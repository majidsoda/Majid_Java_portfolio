...
public class Grade {
	...
	/*
	 * if score within 90 and 100 inclusive, return 'A' if score within 80 and 89
	 * inclusive, return 'B' if score within 70 and 79 inclusive, return 'C' if
	 * score within 60 and 69 inclusive, return 'D' if score within 0 and 59
	 * inclusive, return 'F' otherwise return '0'
	 * 
	 */
